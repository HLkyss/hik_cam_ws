...
void CaptureAndPublish(image_transport::Publisher& pub, MV_CC_DEVICE_INFO* deviceInfo);
...
//    image_transport::Publisher pub1 = it.advertise("/cam1/image_raw", 10);
//    image_transport::Publisher pub2 = it.advertise("/cam0/image_raw", 10);
    ...
    std::thread thread1(CaptureAndPublish, std::ref(pub1), stDeviceList.pDeviceInfo[0]);
    std::thread thread2(CaptureAndPublish, std::ref(pub2), stDeviceList.pDeviceInfo[1]);
...
//    if (MV_OK != nRet)
//    {
//        printf("MV_CC_BalanceWhiteAuto fail! nRet [%x]\n", nRet);
//        return;
//    }
...
//    if (MV_OK != nRet)
//    {
//        printf("set GammaEnable fail! nRet [%x]\n", nRet);
//        return;
//    }
//    nRet = MV_CC_SetFloatValue(handle, "Gamma", 5.0);
//    if(MV_OK != nRet){
//        printf("MV_CC_SetEnumValue Gamma fail! nRet [%x]\n", nRet);
//        return;
//    }
//    else
//        printf("MV_CC_SetEnumValue Gain success\n");
...
//        nRet = MV_CC_SetCommandValue(handle, "TriggerSource");
//        if(MV_OK != nRet)
//        {
...
//        }
        ...
        if (MV_OK == nRet) {
            ...
            pub.publish(msg);
            free(pDataForBGR); // Free the memory after publishing
            pDataForBGR = NULL; // Reset pointer to NULL after freeing
    ...
    free(pData); // Free pData at the end
