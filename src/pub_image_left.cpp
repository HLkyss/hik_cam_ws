...
int main(int argc, char** argv){
	ros::init(argc, argv, "pub_image_left");
	ros::NodeHandle nh;

	image_transport::ImageTransport it(nh);
//	image_transport::Publisher pub = it.advertise("HikImage_left", 10);
	image_transport::Publisher pub = it.advertise("/camera/left/image_raw", 10);
	...
	unsigned int nIndex = 1; // @TODO 选择相机id
	// 选择设备并创建句柄
